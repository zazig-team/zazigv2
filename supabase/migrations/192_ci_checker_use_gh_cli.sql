-- Migration 192: Update ci-checker prompt to use gh CLI instead of raw curl.
-- Migration 191 was already applied with the old curl/GITHUB_TOKEN version,
-- so this re-applies the prompt with the gh CLI fix.
