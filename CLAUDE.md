...
2. You are on branch `expert/hotfix-engineer-7ca1d84f` — all your work goes here
...
5. When done: push your branch and merge to master, then delete the remote expert branch
   - `git push origin expert/hotfix-engineer-7ca1d84f`
   - `git checkout master && git merge expert/hotfix-engineer-7ca1d84f && git push origin master`
   - `git push origin --delete expert/hotfix-engineer-7ca1d84f`
