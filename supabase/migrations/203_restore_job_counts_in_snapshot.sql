-- 203_restore_job_counts_in_snapshot.sql
-- Date: 2026-03-24
-- Purpose: Restore per-feature job counts (jobs_total, jobs_done, error flags) in pipeline
--          snapshot that were dropped by 202_snapshot_promoted_version.sql. That migration
--          added promoted_version to completed_features but inadvertently removed the
--          LEFT JOIN LATERAL and job count fields from features_by_status.
