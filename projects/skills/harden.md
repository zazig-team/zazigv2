...
| zazig send-message-to-human --company $ZAZIG_COMPANY_ID --text "<message>" [--conversation-id <id>] [--job-id <id>] | Notify user of completion / near-duplicate alerts | Stage 2a, Stage 6 |
