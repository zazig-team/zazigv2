...
If there are unstaged/untracked changes, stage and commit them with a good message. Follow the repo's commit style. End with `Co-Authored-By: Claude <noreply@anthropic.com>`.
