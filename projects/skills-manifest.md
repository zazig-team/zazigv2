...
|-------|----------|---------|
| standup | .claude/skills/ | Pipeline standup ceremony |
| scrum | .claude/skills/ | Sprint planning ceremony |
| dispatch-subagent | projects/skills/ | Delegate scoped tasks to sub-agents |
...
| dispatch-subagent | Sub-agent delegation | Used by CPO; also listed under CPO persistent skills |
...
| init | .claude/skills/ | V1 Trello-based scaffolding, no longer used | 2026-03-05 |
| continuous-learning | .claude/skills/ | Not used, bloated (350 lines) | 2026-03-05 |
