-- Update request_standalone_work to insert jobs as 'created' instead of 'queued'.
-- The orchestrator will enrich them with prompt_stack and transition to 'queued'.
...
BEGIN
  ...
  WHERE company_id = p_company_id
    ...
    AND status IN ('created', 'queued', 'executing')
  LIMIT 1;
