...
### Settings panel (new section on dashboard)
...
The human can review all auto-promotions on the dashboard and reverse any that shouldn't have gone through.
...
### Phase 2c: Dashboard toggles

11. Add automation settings columns to companies table
12. WebUI: add settings panel with toggles
13. WebUI: add audit trail view (auto-promoted ideas, with ability to reverse)
14. Edge function: expose toggle read/write for dashboard

### Phase 2d: Safety and observability

15. Events logging for all auto-promotions
16. Standup skill: report auto-promoted ideas since last standup
17. Rate limiting: max N auto-promotions per heartbeat cycle (prevent runaway)
18. `pipeline_hold` master switch wired through all auto-promotion paths
...
- The triage skill (still used for manual triage sessions)
